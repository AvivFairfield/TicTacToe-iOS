...
//  XO
//
//  Created by Aviv Cohen on 24/11/2025.
//
...
private extension GameSetupView {
   ...
   var gameSetupSectionView: some View {
      VStack(spacing: 28) {
         ...
         SelectionGroupView(title: "Difficulty", options: Difficulty.allCases, selected: $viewModel.selectedDifficulty)
         SelectionGroupView(title: "Who Goes First?", options: FirstTurn.allCases, selected: $viewModel.selectedFirstTurn)
      }
   }
